...
import { Star, ShoppingCart, Share, Search, Filter, X, ChevronDown, Tag, Package, ArrowUpRight, Heart, Sliders, Grid, List, TrendingUp, Percent, ChevronRight, CreditCard } from 'lucide-react';
...
export default function ProductsPage() {
  ...
  }, [selectedCategory, selectedSubcategory, searchQuery, priceRange, ratings, discount, showFavoritesOnly, selectedBrands]);
  ...
  }, [products, selectedCategory, selectedSubcategory, searchQuery, priceRange, sortBy, ratings, discount, showFavoritesOnly, favorites, selectedBrands]);
                                  ...
                                  <div className="p-4">
                                    ...
                                    <div className="flex space-x-2">
                                      <button 
                                        ...
                                        className={`flex-1 text-sm py-2 px-2 rounded-md flex items-center justify-center ${
                                          product.availableQuantity > 0
                                    ...
                                    <div className="flex items-center justify-between mt-auto">
                                      ...
                                      <div className="flex space-x-2">
                                        <button 
                                          onClick={() => handleAddToCart(product._id)}
                                          disabled={product.availableQuantity <= 0}
                                          className={`text-sm py-2 px-3 rounded-md flex items-center justify-center ${
                                            product.availableQuantity > 0
                                              ? 'bg-teal-600 text-white hover:bg-teal-700 transition-colors' 
                                              : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                          }`}
