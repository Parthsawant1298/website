      ...
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="flex flex-col items-center bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-gray-500 text-sm mt-2">Preparing your business overview</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-grow py-8">
        <div className="container mx-auto px-4">
          {/* Welcome banner */}
          <div className="bg-gradient-to-r from-teal-600 to-teal-800 rounded-2xl shadow-xl p-8 mb-8 text-white relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between relative z-10">
              <div>
                <h1 className="text-3xl font-bold mb-2">Welcome back, {admin?.name.split(" ")[0]}!</h1>
                <p className="text-teal-100 text-lg">Here's what's happening with your business today.</p>
                {error && (
                  <div className="mt-3 bg-red-400 bg-opacity-20 px-4 py-2 rounded-lg text-white flex items-center">
              ...
              <div className="mt-6 md:mt-0 flex flex-wrap gap-3">
                <Link
                  href="/add-product"
                  className="bg-white text-teal-700 hover:bg-teal-50 px-5 py-3 rounded-lg shadow-md flex items-center font-medium transition-colors"
                >
                ...
                <button
                  ...
                  className="bg-teal-500 hover:bg-teal-400 text-white px-5 py-3 rounded-lg shadow-md flex items-center font-medium transition-colors disabled:opacity-70"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border-l-4 border-green-500">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-500 text-sm font-medium uppercase tracking-wider">Average Order Value</p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border-l-4 border-purple-500">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-500 text-sm font-medium uppercase tracking-wider">Conversion Rate</p>
                  <h3 className="text-2xl font-bold text-gray-900 mt-1">{dashboardData.insights.conversionRate}%</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border-l-4 border-indigo-500">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-500 text-sm font-medium uppercase tracking-wider">Top Category</p>
          ...
          {(dashboardData.stats.outOfStockProducts > 0 ||
            ...
            <div className="mb-8">
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-xl shadow-md">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="mt-2 text-yellow-700">
                      <ul className="list-disc list-inside space-y-2">
                        ...
                        {dashboardData.stats.lowStockProducts > 0 && (
                          <li className="flex items-start">
                            <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-amber-100 text-amber-500 mr-2">
                              <AlertTriangle size={12} />
                            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-gray-500 text-sm font-medium uppercase tracking-wider">Total Products</p>
                  <h3 className="text-3xl font-bold text-gray-900 mt-2">{dashboardData.stats.totalProducts}</h3>
                  <div className="flex flex-wrap gap-2 text-xs mt-3">
                    {dashboardData.stats.lowStockProducts > 0 && (
                      <span className="text-amber-600 bg-amber-50 px-2 py-1 rounded-full flex items-center">
                ...
                <div className="h-14 w-14 bg-teal-100 rounded-full flex items-center justify-center text-teal-600">
                  <Package size={28} />
                </div>
              </div>
              <Link
                href="/admin/products"
                className="mt-4 inline-flex items-center text-teal-600 text-sm font-medium hover:text-teal-700 group"
              >
                View all products
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-gray-500 text-sm font-medium uppercase tracking-wider">Active Users</p>
                  <h3 className="text-3xl font-bold text-gray-900 mt-2">{dashboardData.stats.totalUsers}</h3>
                  <p className="text-green-600 bg-green-50 px-2 py-1 rounded-full text-xs mt-3 inline-block">
              ...
              <button className="mt-4 inline-flex items-center text-teal-600 text-sm font-medium hover:text-teal-700 group">
                Manage users
                <ChevronRight size={16} className="ml-1 transition-transform group-hover:translate-x-1" />
              </button>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-gray-900 mt-2">{dashboardData.stats.totalOrders}</h3>
                  <div className="flex flex-wrap gap-2 text-xs mt-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-xl shadow-md p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <Link
                  href="/admin/products"
                  className="text-sm text-teal-600 hover:text-teal-700 flex items-center group"
                >
                  View all
                  <ChevronRight size={16} className="ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              ...
              {dashboardData.recentProducts.length === 0 ? (
                ...
                <div className="overflow-x-auto rounded-xl border border-gray-100">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead>
                      <tr>
                        <th className="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tl-lg">
                          Product
                        </th>
                        ...
                        <th className="px-4 py-3 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider text-right rounded-tr-lg">
                          Actions
                        </th>
                      </tr>
                    </thead>
                      ...
                      {dashboardData.recentProducts.map((product) => (
                        <tr key={product._id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-4 py-4 whitespace-nowrap">
                            ...
                            >
                              {product.quantity <= 0 && <AlertTriangle size={14} className="mr-1" />}
                              {product.quantity <= 5 && product.quantity > 0 && (
                                <AlertTriangle size={14} className="mr-1" />
                              )}
                              {product.quantity > 5 && <CheckCircle size={14} className="mr-1" />}
                              {product.quantity <= 0
                                ? "Out of Stock"
                                : product.quantity <= 5
                          ...
                          <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <Link
                              ...
                              className="text-teal-600 hover:text-teal-700 bg-teal-50 px-3 py-1 rounded-md mr-2"
                            >
                              View
                            </Link>
                            <Link
                              href={`/admin/products/${product._id}/edit`}
                              className="text-blue-600 hover:text-blue-700 bg-blue-50 px-3 py-1 rounded-md"
                            >
                              Edit
                            </Link>
                          </td>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                {dashboardData.recentActivity.length === 0 ? (
                  ...
                  <div className="space-y-4 max-h-80 overflow-y-auto pr-2 -mr-2">
                    {dashboardData.recentActivity.map((activity, index) => (
                      <div
                        key={index}
                        className="flex items-start space-x-3 p-3 hover:bg-gray-50 rounded-xl border border-gray-100 transition-colors"
                      >
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <p className="text-sm font-semibold text-gray-900 mt-2 bg-gray-50 px-2 py-1 rounded inline-block">
                ...
                {dashboardData.categoryStats.length === 0 ? (
                  ...
                  <div className="space-y-5">
                    {dashboardData.categoryStats.slice(0, 5).map((category, index) => {
                      ...
                      return (
                        <div key={category._id} className="bg-gray-50 p-3 rounded-lg">
                          <div className="flex justify-between mb-1">
                            <span className="text-sm font-medium text-gray-800 truncate">{category._id}</span>
                            <span className="text-sm font-medium text-gray-800 bg-white px-2 rounded">
                              {category.count}
                            </span>
                          </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <Link
                    href="/add-product"
                    className="w-full block text-left px-4 py-3 bg-teal-50 text-teal-700 hover:bg-teal-100 rounded-xl transition-colors flex items-center group border border-teal-100"
                  >
                    <div className="p-2 bg-white rounded-lg mr-3 text-teal-600">
                      <Plus size={18} />
                    </div>
                  ...
                  <Link
                    href="/admin/products"
                    className="w-full block text-left px-4 py-3 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-xl transition-colors flex items-center group border border-blue-100"
                  >
                  ...
                  <button
                    onClick={fetchDashboardData}
                    disabled={isRefreshing}
                    className="w-full text-left px-4 py-3 bg-green-50 text-green-700 hover:bg-green-100 rounded-xl transition-colors flex items-center group border border-green-100 disabled:opacity-50"
                  >
                  ...
                  <Link
                    href="/admin/profile"
                    className="w-full block text-left px-4 py-3 bg-purple-50 text-purple-700 hover:bg-purple-100 rounded-xl transition-colors flex items-center group border border-purple-100"
                  >
                  ...
                  return (
                    <div key={index} className="text-center">
                      <div className="h-40 flex items-end justify-center mb-2">
                        <div
                          className="w-16 bg-gradient-to-t from-teal-600 to-teal-400 rounded-t-lg transition-all duration-500 hover:from-teal-700 hover:to-teal-500 cursor-pointer relative group"
                      ...
                      <div className="text-sm font-medium text-gray-800 bg-gray-100 rounded-lg px-2 py-1 mb-1">
                        {monthName}
                      </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-blue-500 to-blue-700 p-6 rounded-xl text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-shadow">
              <div className="absolute top-0 right-0 w-24 h-24 bg-white opacity-10 rounded-full -mt-8 -mr-8 group-hover:scale-110 transition-transform"></div>
            ...
            <div className="bg-gradient-to-br from-green-500 to-green-700 p-6 rounded-xl text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-shadow">
              <div className="absolute top-0 right-0 w-24 h-24 bg-white opacity-10 rounded-full -mt-8 -mr-8 group-hover:scale-110 transition-transform"></div>
              <div className="flex items-center justify-between relative z-10">
                <div>
                ...
                <div className="p-3  text-black bg-white bg-opacity-20 rounded-full">
                  <ArrowUp size={24} className="text-black" />
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-purple-500 to-purple-700 p-6 rounded-xl text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-shadow">
              <div className="absolute top-0 right-0 w-24 h-24 bg-white opacity-10 rounded-full -mt-8 -mr-8 group-hover:scale-110 transition-transform"></div>
              <div className="flex items-center justify-between relative z-10">
                <div>
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-700 p-6 rounded-xl text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-shadow">
              <div className="absolute top-0 right-0 w-24 h-24 bg-white opacity-10 rounded-full -mt-8 -mr-8 group-hover:scale-110 transition-transform"></div>
              <div className="flex items-center justify-between relative z-10">
                <div>
                  <p className="text-orange-100 text-sm font-medium">Categories</p>
                  <p className="text-2xl font-bold mt-1">{dashboardData.categoryStats.length}</p>
                  <div className="mt-2 text-black bg-white bg-opacity-20 px-2 py-1 rounded text-xs inline-block">
                    Product categories
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center justify-center md:justify-end space-x-4 mt-4 md:mt-0">
              <Link href="/admin/help" className="text-gray-500 hover:text-teal-600 transition-colors">
                Help Center
              </Link>
              <Link href="/admin/settings" className="text-gray-500 hover:text-teal-600 transition-colors">
                Settings
              </Link>
              <Link href="/admin/support" className="text-gray-500 hover:text-teal-600 transition-colors">
                Support
              </Link>
            </div>
          </div>
