            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-gray-50 p-3 sm:p-5 rounded-xl shadow-sm">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center">
                  ...
                  <span className="sm:hidden">Customer Info</span>
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-center p-2 bg-white rounded-lg">
                    ...
                    <span className="font-medium text-sm sm:text-base truncate">{selectedOrder.userDetails.name}</span>
                  </div>
                  <div className="flex items-center p-2 bg-white rounded-lg">
                    <Mail size={14} className="text-gray-500 mr-2 sm:mr-3 flex-shrink-0" />
                    <span className="text-sm sm:text-base truncate">{selectedOrder.userDetails.email}</span>
                  </div>
      ...
      <main className="flex-grow py-4 sm:py-6 lg:py-8">
        <div className="container mx-auto px-2 sm:px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
            <div className="bg-gradient-to-br from-blue-500 to-blue-700 p-4 sm:p-6 rounded-xl shadow-md relative overflow-hidden group hover:shadow-lg transition-shadow">
              <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-white opacity-10 rounded-full -mt-6 sm:-mt-8 -mr-6 sm:-mr-8"></div>
              <div className="relative z-10">
                <p className="text-blue-100 text-xs sm:text-sm font-medium">This Month</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold mt-2 text-white">2 Orders</p>
            ...
            <div className="bg-gradient-to-br from-green-500 to-green-700 p-4 sm:p-6 rounded-xl shadow-md relative overflow-hidden group hover:shadow-lg transition-shadow">
              <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-white opacity-10 rounded-full -mt-6 sm:-mt-8 -mr-6 sm:-mr-8"></div>
              <div className="relative z-10">
                <p className="text-green-100 text-xs sm:text-sm font-medium">Revenue Growth</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold mt-2 text-white">-99%</p>
                <div className="mt-2 text-black bg-white bg-opacity-20 px-2 py-1 rounded text-xs inline-block">
                  Month over month
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-500 to-purple-700 p-4 sm:p-6 rounded-xl shadow-md relative overflow-hidden group hover:shadow-lg transition-shadow">
              <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-white opacity-10 rounded-full -mt-6 sm:-mt-8 -mr-6 sm:-mr-8"></div>
              <div className="relative z-10">
                <p className="text-purple-100 text-xs sm:text-sm font-medium">Active Products</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold mt-2 text-white">56</p>
                <div className="mt-2 text-black bg-white bg-opacity-20 px-2 py-1 rounded text-xs inline-block">
                  In stock items
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-700 p-4 sm:p-6 rounded-xl shadow-md relative overflow-hidden group hover:shadow-lg transition-shadow">
              <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-white opacity-10 rounded-full -mt-6 sm:-mt-8 -mr-6 sm:-mr-8"></div>
              <div className="relative z-10">
                <p className="text-orange-100 text-xs sm:text-sm font-medium">Categories</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold mt-2 text-white">12</p>
                <div className="mt-2 text-black bg-white bg-opacity-20 px-2 py-1 rounded text-xs inline-block">
                  Product categories
                </div>
              </div>
